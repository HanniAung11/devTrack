...
const links = [
  ...
  { href: "/developer/schedule", label: "My Schedule", icon: CalendarRange },
  {
    href: "/developer/attendance",
    label: "My Attendance",
    icon: BookOpen,
  },
  {
    href: "/developer/assignments",
    label: "My Assignments",
    icon: ClipboardList,
  },
  { href: "/developer/profile", label: "Profile", icon: UserCircle },
];
  ...
  return (
    <>
      <Button
        variant="ghost"
        size="icon"
        className="fixed left-3 top-3 z-40 text-white hover:bg-slate-800 lg:hidden"
        type="button"
